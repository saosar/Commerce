...
function ShopProvider(props) {
  ...
  const [info, setInfo] = React.useState([]);    //VIENE DE getApiData ///ACTUALIZA EL ESTADO DE data que viene de getData para guardar la API y usar en shopsearchapi  ////api
  ...
  return (
    <ShopContext.Provider value={{
      ...
      openModal,
      setOpenModal,
      info,       ////QUEDA GUARDADA TODA LA INFO DE LA API. ES LA VARIABLE API MAS IMPORTANTE
    }}>
      {props.children}
